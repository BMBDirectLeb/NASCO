...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Else
                Try
                    GetLFMainWindow("LaunchScanningFromClient", LFDocID)
                Catch ex As Exception
                    MsgBox("Error While opening scanning interface, Error: " & ex.Message)
                End Try
            End If
        End If
        End
